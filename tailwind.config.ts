  ...
  theme: {
    extend: {
      colors: {
        ...
        surface: "#FFFFFF",
        tint: "#E8EFF8",
        ink: { DEFAULT: "#0A0A0F", 2: "#1A1A24" },
        muted: "#5A6478",
        subtle: "#8B95A8",
        soft: "#B6BFD0",
        coral: { DEFAULT: "#FF5C39", soft: "#FFE0D6", 2: "#FF7B5C" },
        // legacy aliases — keep so previously-shipped pages still compile
        navy: { DEFAULT: "#0A0A0F", 2: "#1A1A24", 3: "#2A2A36" },
        orange: { DEFAULT: "#FF5C39", soft: "#FF7B5C", deep: "#E64A2A" },
      },
      fontFamily: {
